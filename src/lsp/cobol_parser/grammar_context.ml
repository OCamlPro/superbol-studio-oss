...
let contexts_for_state_num: int -> _ list = function
  ...
  | 1194 -> [Usage_clause   (* ok as none of leftmost terminals are C/S *)]
  | 1196 -> [Usage_clause   (* ok as none of leftmost terminals are C/S *)]
  | 1198 -> [Usage_clause   (* ok as none of leftmost terminals are C/S *)]
  | 1200 -> [Typedef_clause]
  | 1400 -> [Occurs_clause]
  | 1454 -> [Typedef_clause]
  | 1480 -> [Default_clause]
  | 1556 -> [Constant]
  | 1959 -> [Occurs_clause]
  | 1986 -> [Line_clause                             (*NUMBERS only*)]
  | 1988 -> [Line_clause                             (*NUMBERS only*)]
  | 1998 -> [Column_clause              (* NUMBERS & CENTER *)]
  | 2004 -> [Column_clause              (* NUMBERS & CENTER *)]
  | 2009 -> [Column_clause              (* NUMBERS & CENTER *)]
  | 2031 -> [Rounded_phrase]
  | 2101 -> [Screen_descr_entry]
  | 2142 -> [Erase_clause]
  | 2404 -> [Retry_phrase]
  | 2498 -> [Stop_stmt]
  | 2583 -> [Set_stmt]
  | 2643 -> [Set_attribute_stmt]
  | 2731 -> [Resume_stmt]
  | 2749 -> [Read_stmt]
  | 2776 -> [Perform_stmt]
  | 2809 -> [Sharing_phrase]
