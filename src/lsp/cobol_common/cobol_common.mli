...
(** [join_all diags res_l] takes every value of a list of {!type:('a, 'e)
    result} and return a {!type:('a, 'e) list result}. If all the elements in
    the parameter list are [Ok _] then the result is [Ok _] otherwise [Error
    _] *)
