...
CAMLprim value ml_ptr_create(value default_v, value kind_v)
{
	...
	if (Is_some(default_v)) {
		...
		case SINT8: *((int8_t *)data) = (int8_t)Long_val(value_v); break;
		case UINT8: *((uint8_t *)data) = (uint8_t)Long_val(value_v); break;
		case SINT16: *((int16_t *)data) = (int16_t)Long_val(value_v); break;
		case UINT16: *((uint16_t *)data) = (uint16_t)Long_val(value_v); break;
		case SINT32: *((int32_t *)data) = (int32_t)Long_val(value_v); break;
		case UINT32: *((uint32_t *)data) = (uint32_t)Long_val(value_v); break;
		case SINT64: *((int64_t *)data) = (int64_t)Int64_val(value_v); break;
		case UINT64: *((uint64_t *)data) = (uint64_t)Int64_val(value_v); break;
...
CAMLprim value ml_ptr_get(value ptr_v)
{
	...
	case SINT8: res_v = Val_long(*((int8_t *)data)); break;
	case UINT8: res_v = Val_long(*((uint8_t *)data)); break;
	case SINT16: res_v = Val_long(*((int16_t *)data)); break;
	case UINT16: res_v = Val_long(*((uint16_t *)data)); break;
	case SINT32: res_v = Val_long(*((int32_t *)data)); break;
	case UINT32: res_v = Val_long(*((uint32_t *)data)); break;
	case SINT64: res_v = caml_copy_int64(*((int64_t *)data)); break;
	case UINT64: res_v = caml_copy_int64(*((uint64_t *)data)); break;
...
CAMLprim value ml_array_create(value default_v, value kind_v, value size_v)
{
	...
	if (Is_some(default_v)) {
		...
		for (int i = 0; i < size; ++i) {
			...
			case SINT8: ((int8_t *)data)[i] = (int8_t)Long_val(value_v); break;
			case UINT8: ((uint8_t *)data)[i] = (uint8_t)Long_val(value_v); break;
			case SINT16: ((int16_t *)data)[i] = (int16_t)Long_val(value_v); break;
			case UINT16: ((uint16_t *)data)[i] = (uint16_t)Long_val(value_v); break;
			case SINT32: ((int32_t *)data)[i] = (int32_t)Long_val(value_v); break;
			case UINT32: ((uint32_t *)data)[i] = (uint32_t)Long_val(value_v); break;
			case SINT64: ((int64_t *)data)[i] = (int64_t)Int64_val(value_v); break;
			case UINT64: ((uint64_t *)data)[i] = (uint64_t)Int64_val(value_v); break;
...
CAMLprim value ml_array_get(value array_v, value index_v)
{
	...
	case SINT8: res_v = Val_long(((int8_t *)data)[index]); break;
	case UINT8: res_v = Val_long(((uint8_t *)data)[index]); break;
	case SINT16: res_v = Val_long(((int16_t *)data)[index]); break;
	case UINT16: res_v = Val_long(((uint16_t *)data)[index]); break;
	case SINT32: res_v = Val_long(((int32_t *)data)[index]); break;
	case UINT32: res_v = Val_long(((uint32_t *)data)[index]); break;
	case SINT64: res_v = caml_copy_int64(((int64_t *)data)[index]); break;
	case UINT64: res_v = caml_copy_int64(((uint64_t *)data)[index]); break;
...
CAMLprim value ml_array_set(value array_v, value index_v, value value_v)
{
	...
	case SINT8: ((int8_t *)data)[index] = (int8_t)Long_val(value_v); break;
	case UINT8: ((uint8_t *)data)[index] = (uint8_t)Long_val(value_v); break;
	case SINT16: ((int16_t *)data)[index] = (int16_t)Long_val(value_v); break;
	case UINT16: ((uint16_t *)data)[index] = (uint16_t)Long_val(value_v); break;
	case SINT32: ((int32_t *)data)[index] = (int32_t)Long_val(value_v); break;
	case UINT32: ((uint32_t *)data)[index] = (uint32_t)Long_val(value_v); break;
	case SINT64: ((int64_t *)data)[index] = (int64_t)Int64_val(value_v); break;
	case UINT64: ((uint64_t *)data)[index] = (uint64_t)Int64_val(value_v); break;
