...
let%expect_test "definition-malformed-qualifiers" =
  ...
  end_with_postproc [%expect.output];
  [%expect {|
    {"params":{"diagnostics":[{"message":"Invalid syntax","range":{"end":{"character":21,"line":7},"start":{"character":19,"line":7}},"severity":1},{"message":"Invalid syntax","range":{"end":{"character":26,"line":6},"start":{"character":24,"line":6}},"severity":1},{"message":"Invalid syntax","range":{"end":{"character":18,"line":6},"start":{"character":11,"line":6}},"severity":1},{"message":"Missing <qualified name>","range":{"end":{"character":23,"line":5},"start":{"character":23,"line":5}},"severity":4},{"message":"Invalid syntax","range":{"end":{"character":18,"line":5},"start":{"character":11,"line":5}},"severity":1},{"message":"Missing <qualified name>","range":{"end":{"character":21,"line":4},"start":{"character":21,"line":4}},"severity":4}],"uri":"file://__rootdir__/prog.cob"},"method":"textDocument/publishDiagnostics","jsonrpc":"2.0"}
