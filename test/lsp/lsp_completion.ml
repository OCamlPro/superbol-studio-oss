  ...
  let completions_at_position ?key (position: Position.t) =
    ...
    | Some `CompletionList { items; _ } ->
        let pp_comp_item ppf (item: CompletionItem.t) =
          let label = Str.global_replace (Str.regexp "\n") "\\n" item.label in
          Fmt.string ppf label in
...
let%expect_test "eager-division-and-section-completion" =
  ...
  [%expect {|
    ...
    ----           ^
       ...
       4           DATA DIVISION.
    (line 1, character 8):
    List of completions (7 entries): [PROGRAM-ID;INTERFACE-ID.\n;IDENTIFICATION DIVISION.\n;ID DIVISION.\n;FUNCTION-ID;CONTROL DIVISION.\n;CLASS-ID.\n]
    __rootdir__/prog.cob:2.24:
       1
       2 >         IDENTIFICATION DIVISION.
    ----                           ^
    ...
    ----           ^
       ...
       9             STOP RUN.
    (line 6, character 8):
    List of completions (11 entries): [WORKING-STORAGE SECTION.\n;SCREEN SECTION.\n;REPORT SECTION.\n;PROGRAM-ID;PROCEDURE DIVISION;LOCAL-STORAGE SECTION.\n;LINKAGE SECTION.\n;IDENTIFICATION DIVISION.\n;ID DIVISION.\n;END PROGRAM;COMMUNICATION SECTION.\n]
    __rootdir__/prog.cob:7.18:
       4           DATA DIVISION.
       5           WORKING-STORAGE SECTION.
       6           01 DATA-NAME PIC X.
...
let%expect_test "eager-datadiv-completion" =
  ...
  [%expect {|
    ...
    ----              ^
       ...
       8           01 VAR PICTURE X USAGE DISPLAY.
    (line 5, character 11):
    List of completions (74 entries): [VARYING;VALUES;VALUE;VAL-STATUS;USAGE;TYPEDEF;TYPE;TRAILING;SYNCHRONIZED;SIGN;SELECT WHEN;SAME AS;REDEFINES;PROPERTY;PROGRAM-POINTER;PROCEDURE-POINTER;PRESENT WHEN;POINTER;PICTURE;.\n;PACKED-DECIMAL;OCCURS;OBJECT REFERENCE;NATIONAL;LEADING;JUSTIFIED;IS TYPEDEF;IS GLOBAL;IS EXTERNAL;INVALID WHEN;INDEX;GROUP-USAGE;GLOBAL;FUNCTION-POINTER;FLOAT-SHORT;FLOAT-LONG;FLOAT-EXTENDED;FLOAT-DECIMAL-34;FLOAT-DECIMAL-16;FLOAT-BINARY-64;FLOAT-BINARY-32;FLOAT-BINARY-128;FILLER;EXTERNAL;DYNAMIC;DISPLAY;DESTINATION;DEFAULT;CONSTANT RECORD;COMP-X;COMP-N;COMP-9;COMP-6;COMP-5;COMP-4;COMP-3;COMP-2;COMP-15;COMP-10;COMP-1;COMP-0;COMP;CLASS;BLANK;BIT;BINARY-SHORT;BINARY-LONG;BINARY-DOUBLE;BINARY-C-LONG;BINARY-CHAR;BINARY;BASED;ANY LENGTH;ALIGNED]
    __rootdir__/prog.cob:6.14:
       3           PROGRAM-ID. prog.
       4           DATA DIVISION.
       5           WORKING-STORAGE SECTION.
    ...
    ----                 ^
       ...
       8           01 VAR PICTURE X USAGE DISPLAY.
    (line 5, character 14):
    List of completions (75 entries): [VARYING;VALUES;VALUE;VAL-STATUS;USAGE;TYPEDEF;TYPE;TRAILING;SYNCHRONIZED;SIGN;SELECT WHEN;SAME AS;RENAMES;REDEFINES;PROPERTY;PROGRAM-POINTER;PROCEDURE-POINTER;PRESENT WHEN;POINTER;PICTURE;.\n;PACKED-DECIMAL;OCCURS;OBJECT REFERENCE;NATIONAL;LEADING;JUSTIFIED;IS TYPEDEF;IS GLOBAL;IS EXTERNAL;INVALID WHEN;INDEX;GROUP-USAGE;GLOBAL;FUNCTION-POINTER;FLOAT-SHORT;FLOAT-LONG;FLOAT-EXTENDED;FLOAT-DECIMAL-34;FLOAT-DECIMAL-16;FLOAT-BINARY-64;FLOAT-BINARY-32;FLOAT-BINARY-128;EXTERNAL;DYNAMIC;DISPLAY;DESTINATION;DEFAULT;CONSTANT RECORD;CONSTANT;COMP-X;COMP-N;COMP-9;COMP-6;COMP-5;COMP-4;COMP-3;COMP-2;COMP-15;COMP-10;COMP-1;COMP-0;COMP;CLASS;BLANK;BIT;BINARY-SHORT;BINARY-LONG;BINARY-DOUBLE;BINARY-C-LONG;BINARY-CHAR;BINARY;BASED;ANY LENGTH;ALIGNED]
    __rootdir__/prog.cob:7.34:
       4           DATA DIVISION.
       5           WORKING-STORAGE SECTION.
       6           01 AA PIC X.
    ...
    ----                            ^
      ...
      10           PROCEDURE DIVISION.
    (line 7, character 25):
    List of completions (75 entries): [VARYING;VALUES;VALUE;VAL-STATUS;USAGE;TYPEDEF;TYPE;TRAILING;SYNCHRONIZED;SIGN;SELECT WHEN;SAME AS;REDEFINES;PROPERTY;PROGRAM-POINTER;PROCEDURE-POINTER;PRESENT WHEN;POINTER;PICTURE;.\n;PACKED-DECIMAL;OCCURS;OBJECT REFERENCE;NATIONAL;LOCALE;LEADING;JUSTIFIED;IS TYPEDEF;IS GLOBAL;IS EXTERNAL;INVALID WHEN;INDEX;GROUP-USAGE;GLOBAL;FUNCTION-POINTER;FLOAT-SHORT;FLOAT-LONG;FLOAT-EXTENDED;FLOAT-DECIMAL-34;FLOAT-DECIMAL-16;FLOAT-BINARY-64;FLOAT-BINARY-32;FLOAT-BINARY-128;EXTERNAL;DYNAMIC;DISPLAY;DESTINATION;DEPENDING;DEFAULT;CONSTANT RECORD;COMP-X;COMP-N;COMP-9;COMP-6;COMP-5;COMP-4;COMP-3;COMP-2;COMP-15;COMP-10;COMP-1;COMP-0;COMP;CLASS;BLANK;BIT;BINARY-SHORT;BINARY-LONG;BINARY-DOUBLE;BINARY-C-LONG;BINARY-CHAR;BINARY;BASED;ANY LENGTH;ALIGNED]
    __rootdir__/prog.cob:8.31:
       5           WORKING-STORAGE SECTION.
       6           01 AA PIC X.
       7           01 BB PIC X VAL-STATUS AA WHEN ERROR ON RELATION FOR AA.
    ...
    ----                                  ^
      ...
      11             DISPLAY DATA-NAME.
    (line 8, character 31):
    List of completions (13 entries): [ZEROS;WHEN;TO FALSE;THRU;SPACES;SET;QUOTES;.\n;LOW-VALUES;IN;HIGH-VALUES;FALSE;ALL] |}]
...
let%expect_test "eager-control-completion" =
  ...
  [%expect {|
    ...
    ----           ^
       ...
       8           PROCEDURE DIVISION.
    (line 5, character 8):
    List of completions (6 entries): [PROGRAM-ID;INTERFACE-ID.\n;IDENTIFICATION DIVISION.\n;ID DIVISION.\n;FUNCTION-ID;CLASS-ID.\n] |}]
