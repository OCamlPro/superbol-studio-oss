...
let%expect_test "division-and-section-completion" =
  ...
  [%expect {|
    ...
    (line 4, character 8):
    List of completions (15 entries): [WORKING-STORAGE;SD;SCREEN;REPORT;PROGRAM-ID;PROCEDURE;LOCAL-STORAGE;LINKAGE;IDENTIFICATION;ID;FILE;FD;DATA;COMMUNICATION;END PROGRAM]
    ...
    ----           ^
       ...
       9             STOP RUN.
    (line 6, character 8):
    List of completions (11 entries): [WORKING-STORAGE;SCREEN;REPORT;PROGRAM-ID;PROCEDURE;LOCAL-STORAGE;LINKAGE;IDENTIFICATION;ID;COMMUNICATION;END PROGRAM]
...
let%expect_test "procedure-completion" =
  ...
  [%expect {|
    ...
    ----                     ^
      ...
      12               ON SIZE ERROR
    (line 9, character 18):
    List of completions (7 entries): [TO;OF;IN;AS;OF SUPER;AS UNIVERSAL;AS FACTORY OF]
    ...
    List of completions (7 entries): [OF;IN;BY;AS;OF SUPER;AS UNIVERSAL;AS FACTORY OF]
    ...
    List of completions (79 entries): [WRITE;VALIDATE;UNSTRING;UNLOCK;TRANSFORM;TERMINATE;SUPPRESS;SUPER;SUBTRACT;STRING;STOP;START;SORT;SET;SEND;SELF;SEARCH;ROUNDED;REWRITE;RETURN;RESUME;RELEASE;RECEIVE;READ;RAISE;PURGE;.;PERFORM;PAGE-COUNTER;OPEN;ON SIZE ERROR;OF;NULL;NOT ON SIZE ERROR;NEXT SENTENCE;MULTIPLY;MOVE;MERGE;LINE-COUNTER;LINAGE-COUNTER;INVOKE;INSPECT;INITIATE;INITIALIZE;IN;IF;GOBACK;GO;GIVING;GENERATE;FUNCTION;FREE;EXIT;EXCEPTION-OBJECT;EVALUATE;ENTRY;ENTER;END-MULTIPLY;ENABLE;DIVIDE;DISPLAY;DISABLE;DELETE;CONTINUE;COMPUTE;CLOSE;CANCEL;CALL;AS;ALTER;ALLOCATE;ADDRESS;ADD;ACCEPT;OF SUPER;AS UNIVERSAL;AS FACTORY OF;AA;BB]
