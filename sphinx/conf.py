...
# -*- coding: utf-8 -*-
#
# superbol-studio-oss documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    (master_doc, 'superbol-studio-oss.tex', 'superbol-studio-oss Documentation',
     'author', 'manual'),
]
...
man_pages = [
    (master_doc, 'superbol-studio-oss', 'superbol-studio-oss Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'superbol-studio-oss', 'superbol-studio-oss Documentation',
     author, 'superbol-studio-oss', 'One line description of project.',
     'Miscellaneous'),
]
